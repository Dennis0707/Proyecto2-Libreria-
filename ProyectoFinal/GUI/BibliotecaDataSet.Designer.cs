...
namespace GUI {
    ...
    public partial class BibliotecaDataSet : global::System.Data.DataSet {
        ...
        public partial class ClientesDataTable : global::System.Data.TypedTableBase<ClientesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ClientesRow AddClientesRow(string Cedula, string Nombre, string Apellidos, string Telefono, string Direccion) {
...
namespace GUI.BibliotecaDataSetTableAdapters {
    ...
    public partial class ClientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Clientes] WHERE (([Cedula] = @Original_Cedula) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Apellidos = 1 AND [Apellidos] IS NULL) OR ([Apellidos] = @Original_Apellidos)) AND ((@IsNull_Telefono = 1 AND [Telefono] IS NULL) OR ([Telefono] = @Original_Telefono)) AND ((@IsNull_Direccion = 1 AND [Direccion] IS NULL) OR ([Direccion] = @Original_Direccion)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Clientes] ([Cedula], [Nombre], [Apellidos], [Telefono], [Direc" +
                "cion]) VALUES (@Cedula, @Nombre, @Apellidos, @Telefono, @Direccion);\r\nSELECT Ced" +
                "ula, Nombre, Apellidos, Telefono, Direccion FROM Clientes WHERE (Cedula = @Cedul" +
                "a)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Clientes] SET [Cedula] = @Cedula, [Nombre] = @Nombre, [Apellidos] = @Apellidos, [Telefono] = @Telefono, [Direccion] = @Direccion WHERE (([Cedula] = @Original_Cedula) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Apellidos = 1 AND [Apellidos] IS NULL) OR ([Apellidos] = @Original_Apellidos)) AND ((@IsNull_Telefono = 1 AND [Telefono] IS NULL) OR ([Telefono] = @Original_Telefono)) AND ((@IsNull_Direccion = 1 AND [Direccion] IS NULL) OR ([Direccion] = @Original_Direccion)));
SELECT Cedula, Nombre, Apellidos, Telefono, Direccion FROM Clientes WHERE (Cedula = @Cedula)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::GUI.Properties.Settings.Default.BibliotecaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Cedula, Nombre, Apellidos, Telefono, Direccion FROM dbo.Clientes";
        ...
        public virtual int Fill(BibliotecaDataSet.ClientesDataTable dataTable) {
        ...
        public virtual BibliotecaDataSet.ClientesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BibliotecaDataSet.ClientesDataTable dataTable = new BibliotecaDataSet.ClientesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BibliotecaDataSet.ClientesDataTable dataTable) {
        ...
        public virtual int Delete(string Original_Cedula, string Original_Nombre, string Original_Apellidos, string Original_Telefono, string Original_Direccion) {
        ...
        public virtual int Insert(string Cedula, string Nombre, string Apellidos, string Telefono, string Direccion) {
            if ((Cedula == null)) {
        ...
        public virtual int Update(string Cedula, string Nombre, string Apellidos, string Telefono, string Direccion, string Original_Cedula, string Original_Nombre, string Original_Apellidos, string Original_Telefono, string Original_Direccion) {
            if ((Cedula == null)) {
                throw new global::System.ArgumentNullException("Cedula");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Apellidos, string Telefono, string Direccion, string Original_Cedula, string Original_Nombre, string Original_Apellidos, string Original_Telefono, string Original_Direccion) {
            return this.Update(Original_Cedula, Nombre, Apellidos, Telefono, Direccion, Original_Cedula, Original_Nombre, Original_Apellidos, Original_Telefono, Original_Direccion);
        }
    }
